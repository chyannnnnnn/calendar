...
// ─── Add event ───────────────────────────────────────────────────────────────
export async function addEvent({ title, date, startTime, endTime, isPrivate, ownerId, eventType, location, location_obj, notes }) {
  const event = {
    id:           generateId(),
    owner_id:     ownerId,
    title,
    ...
    location:     location || '',
    location_lat: location_obj?.lat ?? null,
    location_lng: location_obj?.lng ?? null,
    notes:        notes || '',
